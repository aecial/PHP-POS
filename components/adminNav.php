<nav class="h-[75px] flex justify-between items-center px-4 w-[100%] bg-slate-800 text-white">
  ...
  <a href="itemManagement.php" class="underline underline-offset-4">ITEM MANAGEMENT</a>
  <a href="employeeManagement.php" class="underline underline-offset-4">EMPLOYEE MANAGEMENT</a>
  <a href="dashboard.php" class="underline underline-offset-4">DASHBOARD</a>
