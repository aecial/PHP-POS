<?php
  ...
  */
  ...
  if($_SESSION['role'] == "cashier" || $_SESSION['role'] == "manager") {
      header("Location: ../pages/pos.php?".$_SESSION['role']."");    
  }
?>
<!DOCTYPE html>
<html lang="en">
